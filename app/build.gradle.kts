...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 35
        versionCode = providers.gradleProperty("IAC33_VERSION_CODE").orElse("200000").get().toInt()
        versionName = providers.gradleProperty("IAC33_VERSION_NAME").orElse("2.0.0").get()
